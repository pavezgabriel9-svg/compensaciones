...
def calcular_sueldo_base_desde_liquido(sueldo_liquido_deseado, precision=100, tipo_salud="isapre"):
    ''''
    ...
    # Función auxiliar para estimar el líquido desde un sueldo base
    ...
    while estimar_liquido(sueldo_max) < sueldo_liquido_deseado:
        sueldo_max *= 2  # duplicamos hasta pasarnos del líquido objetivo
